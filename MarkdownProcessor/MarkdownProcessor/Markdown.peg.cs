    ...
    #line default
    {
       ...
       IList<Node>
            ...
            > paragraph(ref Cursor cursor)
        {
            ...
            if (l0.Count >= 1)
            {
                r1 = new ParseResult<IList<IList<ContentNode>>>(startCursor1, cursor, l0.AsReadOnly());
            }
            else
            {
                cursor = startCursor1;
            ...
            > paraHelper(ref Cursor cursor)
        {
            ...
            if (r1 != null)
            {
                ...
                if (l0.Count >= 1)
                {
                    r3 = new ParseResult<IList<ContentNode>>(startCursor2, cursor, l0.AsReadOnly());
                }
                else
                {
                    cursor = startCursor2;
                ...
                if (r3 != null)
                {
                    ...
                    if (l1.Count >= 0)
                    {
                        r5 = new ParseResult<IList<string>>(startCursor3, cursor, l1.AsReadOnly());
                    }
                    else
                    {
                        cursor = startCursor3;
                    ...
                    if (r5 != null)
                    {
                        r0 = this.ReturnHelper<IList<ContentNode>>(startCursor0, cursor, state =>
            ...
            > atxHeading(ref Cursor cursor)
        {
            ...
            if (r1 != null)
            {
                ...
                if (r3 != null)
                {
                    ...
                    if (l1.Count >= 0)
                    {
                        r4 = new ParseResult<IList<ContentNode>>(startCursor2, cursor, l1.AsReadOnly());
                    }
                    else
                    {
                        cursor = startCursor2;
                    ...
                    if (r4 != null)
                    {
                        ...
                        if (l2.Count >= 0)
                        {
                            r6 = new ParseResult<IList<string>>(startCursor3, cursor, l2.AsReadOnly());
                        }
                        else
                        {
                            cursor = startCursor3;
                        ...
                        if (r6 != null)
                        {
                            ...
                            if (l3.Count >= 0)
                            {
                                r8 = new ParseResult<IList<string>>(startCursor4, cursor, l3.AsReadOnly());
                            }
                            else
                            {
                                cursor = startCursor4;
            ...
            > italic(ref Cursor cursor)
        {
            ...
            if (r0 == null)
            {
                ...
                if (r1 != null)
                {
                    ...
                    if (l0.Count >= 1)
                    {
                        r2 = new ParseResult<IList<ContentNode>>(startCursor1, cursor, l0.AsReadOnly());
                    }
                    else
                    {
                        cursor = startCursor1;
            ...
            if (r0 == null)
            {
                ...
                if (r5 != null)
                {
                    ...
                    if (l1.Count >= 1)
                    {
                        r6 = new ParseResult<IList<ContentNode>>(startCursor3, cursor, l1.AsReadOnly());
                    }
                    else
                    {
                        cursor = startCursor3;
                    ...
                    if (r6 != null)
                    {
                        ...
                        if (r8 != null)
                        {
                            r0 = this.ReturnHelper<ContentNode>(startCursor2, cursor, state =>
                                #line 63 "Markdown.peg"
                                                                                                                   new Italics(value,null)
                                #line default
                                );
